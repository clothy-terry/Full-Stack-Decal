...
apiKey = "8c8a74a34cd2ccf0cad50575a4629c3d";
...
async function getLatLon(city) {
  ...
  let formattedUrl = geocodingUrl+cityName+"&appid="+apiKey;/* YOUR CODE HERE */
  ...
  return {
    "lat": data["lat"]/* YOUR CODE HERE */,
    "lon": data["lon"]/* YOUR CODE HERE */
  }
}
...
async function getWeather(lat, lon) {
  /* YOUR CODE HERE */
  let formattedWeatherUrl = weatherUrl+"lat="+lat+"&lon="+lon+"&appid="+apiKey;
  let weatherData = await apiCall(formattedWeatherUrl);
  return {
    "main": weatherData["main"]/* YOUR CODE HERE */,
    "description": weatherData["description"] /* YOUR CODE HERE */
  }
}
